...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CustomExceptions.EmailAlreadyRegisteredException.class)
    public ResponseEntity<ErrorResponse> handleEmailAlreadyRegistered(CustomExceptions.EmailAlreadyRegisteredException ex) {
        ErrorResponse error = new ErrorResponse(
                HttpStatus.CONFLICT.value(),
                ex.getMessage(),
                LocalDateTime.now()
    ...
    @ExceptionHandler(CustomExceptions.GoogleAuthException.class)
    public ResponseEntity<ErrorResponse> handleGoogleAuth(CustomExceptions.GoogleAuthException ex) {
        ErrorResponse error = new ErrorResponse(
